//Coloquei só 300 perguntas, pq honestamente não faz sentido ter mais do que isto, já que o total define se o jogo é pra ser grande ou não (em relação a tempo), e como eu acho que os cara não vai querer ficar mt nisso, acho que é o suficiente, fora que, após conversar com os desenvolvedores do Lord Bot, descobri que inicialmente eles colocaram só 50 perguntas, dps a comunidade que foi aumentando, entt é isso, se quiserem que eu coloque mais, é suave, mas não vejo nenhuma necessidade nisso

//e sim, dei esses espaços aqui só pra ter exatamente 6k de linha
